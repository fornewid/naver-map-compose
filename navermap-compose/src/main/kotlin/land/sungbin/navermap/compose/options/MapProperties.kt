 ...
 * 계수가 1일 경우 배경 지도와 동일한 비율로 멀리 있는 심벌은 작아지고 가까이 있는 심벌은 커지며, 0에 가까울수록 원근 효과가
 * 감소합니다.
 * 기본값은 1입니다.
 ...
 * @param locationTrackingMode 위치 추적 모드를 지정합니다. 기본값은 [LocationTrackingMode.None]입니다.
 */
...
/** 지도의 유형을 나타내는 열거형 */
@Immutable
public enum class MapType(public val value: NaverMap.MapType) {
  /** 일반 지도 */
